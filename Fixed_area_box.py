...
# Dictionary of atomic masses for elements C, H, N, O (in atomic mass units, amu)
atomic_masses = {6: 12.01077, 1: 1.00794, 7: 14.0067, 8: 15.9994}

# Conversion factor from Bohr to Angstrom
bohr_to_angstrom = 0.529177

# Dictionary containing molecule data: (experimental impact sensitivity, molecule number, torsion frequency)
i50_values = {
    "TET-1": (2, 1, 76.5324),
    "NP1": (2.5, 2, 66.1026),
    "HNB": (2.75, 3, 83.0775),
...
# Normalize the DOS based on atom count
...
def generate_dos(freqs, log_file, atom_count, bwidth, gwidth, filtered_freqs):
    """
    Generates a normalized DOS from vibrational frequencies.
    Args:
...
# Plot normalized integrals vs I50 values
def plot_max_min_normalised(i50_values, integral_values, molecule_omega_max, freq_data, molecule_bounds, dpi, base_dir):
    """
    Plots normalized integral values vs I50 values with a linear fit on inverse I50.
    Args:
...
if __name__ == "__main__":
    ...
    # Generate normalized integral plot and summary table
