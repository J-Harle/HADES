...
def create_plot_directories(dataset_name):
    ...
    figures_root = os.path.join(root_dir, "..", "FIGURES", "v_1_0_1", "NITRAMINE")
...
def plot_be_dos(frequency_axis, be_dos, dpi, save_path=None):
    plt.figure(figsize=(12, 9), dpi=dpi)
    ...
    for csv_name, dataset in runs:
        ...
        for mol in all_data:
            ...
            if plot_enabled["be_dos"] and "be_dos" in mol and "frequency_axis" in mol:
                ...
                plot_be_dos(mol["frequency_axis"], mol["be_dos"], dpi, save_path=path)
