...
def write_updated_csv(data, original_csv="raw.csv", output_csv="raw.csv"):
    ...
    # Map computed values by molecule
    ...
    # print(f"[INFO] CSV updated with omega_max and integral_freq_count: {output_csv}")


if __name__ == "__main__":
    data = read_data_from_csv("raw.csv")
    data = non_dihedral_omax(data)
    write_updated_csv(data, original_csv="raw.csv", output_csv="raw.csv")
    print()
    # print(data[0].keys())
