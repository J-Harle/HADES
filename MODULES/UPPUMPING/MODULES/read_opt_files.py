...
def read_extended_csv(
    ...
    csv_path = os.path.join(script_dir, "Storm_dataset.csv")
...
def read_txt_xyz(molecules):
    ...
    base_dir = os.path.abspath(os.path.join(script_dir, "..", "OPTIMISED_STRUCTURES", "STORM", "SMALL_MODEL"))
...
if __name__ == "__main__":
    # cluster_list = ["nitramine", "nitrate ester", "nitro-1,2,3-triazole", "nitro-1,2,4-triazole", 
    #                 "nitroaliphatic", "nitroaliphatic containing other functional groups", "nitroaromatic",
    #                 "nitroaromatic with C-H linkage", "nitrofurazan", "nitroimidazole", 
    #                 "nitropyrazole", "nitropyridine", "nitropyrimidine"]
    
    filter_cluster_id = "nitroaliphatic containing other functional groups" # "STORM"
