...
def read_csv(csv_path):
    ...
    Rows without an enthalpy of formation value are skipped because the
    Kamlet-Jacobs heat-release calculation requires `Hf /kJmol-1`.
    ...
    -------
    list[dict]
        List of molecule dictionaries containing SMILES, enthalpy of formation,
        and CID values.
    """
    data = []
